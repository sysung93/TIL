...
public class BoardDao {
	...
	public BoardDao() {
		boardList.add(new BoardDto(1, "제목1", "내용1", "작성자1"));
		boardList.add(new BoardDto(2, "제목2", "내용2", "작성자2"));
		boardList.add(new BoardDto(3, "제목3", "내용3", "작성자3"));
		boardList.add(new BoardDto(4, "제목4", "내용4", "작성자4"));
		boardList.add(new BoardDto(5, "제목5", "내용5", "작성자5"));	
	}
	...
	public void search() {
		...
		for(BoardDto dto : boardList) {
			if(dto.getWriter().equals(name)) {
				found = true; //값이 바뀌면서 break 문으로 중간에 빠져나왔다는걸 이 변수를 통해 알 수 있다.
				findDto = dto;
				break;
			}
		}
